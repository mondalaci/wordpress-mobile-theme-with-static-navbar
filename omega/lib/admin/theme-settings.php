...
function omega_save_theme_settings( $settings ) {
	...
	if ( !isset( $_POST['reset'] ) ) {		
		...
		$settings['content_archive_limit'] =  sanitize_text_field( $settings['content_archive_limit'] );
		$settings['content_archive_more'] =  sanitize_text_field( $settings['content_archive_more'] );
